  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute right-6 top-28 z-10 hidden w-[15vw] max-w-[220px] md:right-10 lg:block"
      >
        <div className="border border-graphite/15 bg-paper-dim p-2 shadow-[0_30px_60px_-20px_rgba(26,28,30,0.25)]">
      ...
      <motion.div
        ...
        className="relative z-10 flex items-center justify-between lg:pr-[240px]"
      >
      ...
      <motion.div
        ...
        className="relative z-10 my-auto lg:pr-[260px] xl:pr-[300px]"
      >
        <motion.h1
